...
const PdfDow: React.FC<Props> = React.forwardRef((props, ref) => {
  ...
  const _noPageOrderFactoryList = async () => {
    ...
    const total: any = [];
    const totalids: any = [];
    const factoryModelId: any = res.result[0].factoryModelId;
    ...
    setids(totalids);
    setmodelid(factoryModelId);
    formRef?.current?.setFieldsValue({
      useMode: factoryModelId,
    });
    if (factoryModelId) {
      const result: any = await pjModelData(factoryModelId);
  ...
  //   '<p style="line-height:1;"><strong><font size="1">二、质量要求、技术标准、供方对质量负责的条件和期限。</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp; 质量按样品，可对样品质量予以说明。供方交付的货物，应当与样品及其说明的质量一致，但是如果货物出运后，外商对商品的质量，型号、规格、包装等问题提出索赔，则需方受到的所有损失均由供方承担，因需方的过失原因除外。供方对质量负责的期限为自交货日起1年。</font></p><p style="line-height:1;"><strong><font size="1">三、交货时间及数量、交货地点、方式、运输方式及到达站（港）和费用负担。</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp; 由供方于合同签订日30天内将货物运到需方指定的交货地，由此发生的运杂费由供方承担。</font></p><p style="line-height:1;"><strong><font size="1">四、包装标准及尺码。</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp;包装的标准： 出口纸箱 ；唛头及尺码及其他要求由需方在供方交货前及时告知供方。</font></p><p style="line-height:1;"><strong><font size="1">五、 验收标准、方法及提出异议期限。</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp;需法定商检的货物由供方进行商检，费用由供方承担。供方应在交货前5日内将商检单交到需方，由需方 确认；不需法定检验的货物，有需方先做初步检验，最终品质由外商确认。如外商对所交货物的质量、包装 、或数量有异议，需方应在供方交货后的3个月内向供方提出。</font></p><p style="line-height:1;"><strong><font size="1">六、货款结算方式及期限。</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp;货出运收汇后，并收到工厂有效的增值税发票后付款。</font></p><p style="line-height:1;"><strong><font size="1">七、违约责任 及违约金。</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp;违反本合同的任一条款均视为违约，违约方需向对方赔偿违约金；守约方损失额超过违约金的，违约方 还需按实际损失金额给对方赔偿。本合同的违约金为相当于本合同总价款的20%的人民币。但下述条件违约金 为（1）供方延迟交货，经需方书面同意接收的供方应向需方支付日万分之五的滞纳金，延迟10天，按违约处 理。（2）需方逾期付款，应向供方支付日万分之二的违约金。</font></p><p style="line-height:1;"><strong><font size="1">八、争议解决方式。</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp;本合同如有未尽事宜，双方友好协商解决，协商不妥产生争议，提交需方有管辖权的法院裁决。</font></p><p style="line-height:1;"><strong><font size="1">九、合同效期。</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp;本合同自双方签字并盖章后即可生效，本合同一式二份，供需双方各执一份。通过传真方式订立本合 同，供方在收到需方的合同传真后，未在贰日内签字并盖章后回传给需方，则本合同自然失效。</font></p><p style="line-height:1;"><strong><font size="1">十、附则：</font></strong></p><p style="line-height:1;"><font size="1">&nbsp; &nbsp; &nbsp;若本合同在执行当中需要修改，应另行签订印刷体的书面协议，作为本合同的附件，对本合同的任何非印 刷体的私自改动均为非法和无效。</font></p>',
  //   // '<p><b>二、 质量要求、技术标准、供方对质量负责的条件和期限。</b></p><p>质量按样品，可对样品质量予以说明。供方交付的货物，应当与样品及其说明的质量一致，但是如果货物出运后，外商对商品的质量，型号、规格、包装等问题提出索赔，则需方受到的所有损失均由供方承担，因需方的过失原因除外。供方对质量负责的期限为自交货日起1年。</p><p><b>三、 交货时间及数量、交货地点、方式、运输方式及到达站（港）和费用负担。</b></p><p>由供方于合同签订日30天内将货物运到需方指定的交货地，由此发生的运杂费由供方承担。</p><p><b>四、包装标准及尺码。</b></p><p>包装的标准： 出口纸箱 ；唛头及尺码及其他要求由需方在供方交货前及时告知供方。</p><p><b>五、 验收标准、方法及提出异议期限。</b></p><p>需法定商检的货物由供方进行商检，费用由供方承担。供方应在交货前5日内将商检单交到需方，由需方 确认；不需法定检验的货物，有需方先做初步检验，最终品质由外商确认。如外商对所交货物的质量、包装 、或数量有异议，需方应在供方交货后的3个月内向供方提出。</p><p><b>六、 货款结算方式及期限。</b></p><p>货出运收汇后，并收到工厂有效的增值税发票后付款。</p><p><b>七、 违约责任 及违约金。</b></p><p>违反本合同的任一条款均视为违约，违约方需向对方赔偿违约金；守约方损失额超过违约金的，违约方 还需按实际损失金额给对方赔偿。本合同的违约金为相当于本合同总价款的20%的人民币。但下述条件违约金 为（1）供方延迟交货，经需方书面同意接收的供方应向需方支付日万分之五的滞纳金，延迟10天，按违约处 理。（2）需方逾期付款，应向供方支付日万分之二的违约金。</p><p><b>八、 争议解决方式。</b></p><p>本合同如有未尽事宜，双方友好协商解决，协商不妥产生争议，提交需方有管辖权的法院裁决。</p><p><b>九、 合同效期。</b></p><p>本合同自双方签字并盖章后即可生效，本合同一式二份，供需双方各执一份。通过传真方式订立本合 同，供方在收到需方的合同传真后，未在贰日内签字并盖章后回传给需方，则本合同自然失效。</p><p><b>十、 附则：</b></p><p>若本合同在执行当中需要修改，应另行签订印刷体的书面协议，作为本合同的附件，对本合同的任何非印 刷体的私自改动均为非法和无效。</p>',
  // ); // 编辑器内容
  ...
  const _pjBillinginfo = async () => {
    ...
    const url = loadimg(res.result.contractUrl);
    setPdf(url);
  };
  React.useEffect(() => {
