<template>
  <el-card class="active-data-card-box">
    <div class="header">
      <div class="left">
        <div class="deployData-Rate">终端服务次数</div>
        <div>
    ...
    <div class="content">
      <div class="item">
        <div class="title">终端服务次数（次）：</div>
        <div class="num" style="color:#FFA736">849454</div>
      </div>
    </div>
            ...
            areaStyle: {
              color: {
                ...
                colorStops: [
                  ...
                  {
                    offset: 0.5,
                    color: "rgba(255,167,54,0.7)"
                  },
                  {
                    offset: 1,
                    color: "rgba(255, 167, 54, 0)"
                  }
                ]
              }
            },
