...
import "./index.scss";
import { Datepicker, BottomModal, Scrollpicker } from "beeshell";
import { Drawer, Button, Label } from "teaset";
import { Text, DeviceEventEmitter } from "react-native";
import dayjs from "dayjs";
import { Timepicker } from "@lib/beeshell";
export default class Index extends Component {
  state = {
    selectTime: dayjs().format("HH:mm"),
    time: "" //显示日期
  };
  componentDidMount() {}
  onShowData = () => {
              ...
              setTimeout(() => {
                ...
                if (selectTime) {
                  this.setState(
                    ...
                    () => {
                      this.props.selectTime(selectTime + ":00");
                    }
                  );
                }
                setTimeout(() => {
