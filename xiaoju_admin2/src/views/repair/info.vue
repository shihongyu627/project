...
export default {
  ...
  data() {
    return {
      mname: 'repair',
      items: [
        { label: '维修数据', desc: '维修的基本信息', type: 'header' },
        { label: '车辆编号', name: 'device_no', value: '', type: 'label' },
        { label: '故障部件', name: 'title', value: '', type: 'label' },
        { label: '故障内容', name: 'content', value: '', type: 'label' },
        { label: '报修地点', name: 'address_info', value: '', type: 'label' },
        { label: '截图', name: 'gallery', value: '', type: 'gallery' },
        { label: '提交者', name: 'user_nick', value: '', type: 'label' },
        { label: '报修时间', name: 'create_time', value: '', type: 'label' },
        { label: '维修记录', desc: '记录的基本信息', type: 'header' },
        { label: '维修记录', name: 'list', value: '', type: 'timeline', dropList: [] },
      ],
      info: {},
    }
  },
